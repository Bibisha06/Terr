...
band3_file = os.path.join(data_dir, "SR_B3.TIF")  # Green
band4_file = os.path.join(data_dir, "SR_B4.TIF")  # Red
band5_file = os.path.join(data_dir, "SR_B5.TIF")  # NIR
output_file = os.path.join(data_dir, "terrain_data.jsonl")  # Output file
